...
ul.topnav li a:hover ,.dropdown:hover .dropbtn{background-color: #bf94e4;}
.dropdown-content {
  display: none;
  position: absolute;
...
.card:hover{
    border-color:#c9a0dc;
   -webkit-box-shadow: 3px 5px 17px -4px #c9a0dc;
box-shadow: 3px 5px 17px -4px #c9a0dc;
}
...
.btn-info:hover{
  background-color:rgb(134, 32, 162) !important;
...
<div class="EC">ExpressCare</div>
   ...
   <ul class="topnav">
     ...
     <li ><a href="adp_home.html">Home</a></li>
   </ul>
<div style="position:relative;">
<img src="../img/doctors.jpg" width=100% style="margin-bottom:70px;">
<div style="position:absolute;font-size:30px;top:90px;left:50px;color:white;font-weight:300;">Book your appointment<br> with India's finest doctors in Express Care</div>
</div>
    <div class="row g-2">
        ...
        <div class="col-md-3">
            ...
            <div class="card p-2 py-3 text-center" style="margin:3%;">
                ...
                <div class="img mb-2">
                    ...
                    <img src="../img/buticon11.jpg" width="120" class="rounded-circle">
                ...
                <div class="mt-4 apointment">
                    ...
                    <a href="speciality-main.php" class="btn btn-info text-uppercase" role="button" >Book Appointment</a>
        ...
        <div class="col-md-3">
            ...
            <div class="card p-2 py-3 text-center"  style="margin:3%;">
                ...
                <div class="img mb-2">
                    ...
                    <img src="../img/buticon2.jpg" width="120" class="rounded-circle">
                ...
                <div class="mt-4 apointment">
                      ...
                      <a href="viewappt.php" class="btn btn-info text-uppercase" role="button">View Appointment History</a>
 ...
 <section class="About">
  <div class="container py-5">
    <div class="row">
      <div class="col-lg-6">
        <img src="../img/doc1.jpg" class="img-fluid" style="border-radius: 40px; width: 500px;" alt="">
      </div>
      <div class="col-lg-6 text-center">
        <h1 class="py-5 text-center" style="color: #c9a0dc;">About Us </h1>
        <p class="text-center pl-5">BookDoc is an online portal for all your health care needs. Our team of medical experts are there for you in every step of the way from finding the right doctor and hospital booking appointments, from providing verified information to any kind of medical assistance in-between.We provide virtu<span id="dots">...</span><span id="more">al appointment system so that patient need not to face hospital crowd.It is also good for emergency purpose.Patient can utilize our website at anytime and anywhere.We helps you to be organized and plan your activities around your meetings with your Doctors.We manage your care through our secure online patient portal.</span></p>
        <button onclick="myFunction()" id="myBtn" class="btn text-white mt-5" style="background-color: #c9a0dc;"> Read More</button>
      </div>
    </div>
  </div>
  </section>
        ...
        <div class="col-lg-3">
          <div class="card py-4 shadow-lg p-3 mb-5 bg-white rounded ">
            <div class="card-head">
              ...
              <p class="pt-3" >Guinness World Record and Limca Book of Records holder, is an internationally known figure in Orthopaedics and Joint Replacement.He has experience of more than 32 years and 10,000 Joint Replacement Surgeries. </p>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#3b5998" class="bi bi-facebook" viewBox="0 0 16 16">
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
</svg>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="cornflowerblue" class="bi bi-twitter" viewBox="0 0 16 16">
        ...
        <div class="col-lg-3">
          <div class="card py-4 shadow-lg p-3 mb-5 bg-white rounded ">
            <div class="card-head">
              ...
              <p class="pt-3" >She is the third female neurosurgeon in mumbai and is ranked amongst the best today.Her passion and perseverance have made her an inspiration for many other women to follow  and has been learning for everyone including medical fraternity.</p>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#3b5998" class="bi bi-facebook" viewBox="0 0 16 16">
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
</svg>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="cornflowerblue" class="bi bi-twitter" viewBox="0 0 16 16">
